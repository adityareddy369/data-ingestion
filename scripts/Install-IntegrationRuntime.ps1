# This script was copied from GitHub azure-quickstart-templates/101-vms-with-selfhost-integration-runtime
# https://github.com/Azure/azure-quickstart-templates/tree/master/101-vms-with-selfhost-integration-runtime
# It was renamed from gatewayInstall.ps1
# The only change to this script was the source uri changed to Artifactory
# Gary Haas - 2020-05-21
...
$uri = "https://artifactory.kroger.com/artifactory/data-management-platform/adf/v5.3.7720/IntegrationRuntime.msi"
