...
SPARK_LISTENERS_VERSION="1.0.0"
SPARK_LISTENERS_LOG_ANALYTICS_VERSION="1.0.0"
SPARK_VERSION="3.0.0"
...
JAR_FILENAME="spark-listeners_3.0.1_2.12-1.0.0.jar"
echo "Copying $JAR_FILENAME"
cp -f "$STAGE_DIR/$JAR_FILENAME" /mnt/driver-daemon/jars
JAR_FILENAME="spark-listeners-loganalytics_3.0.1_2.12-1.0.0.jar"
echo "Copying $JAR_FILENAME"
cp -f "$STAGE_DIR/$JAR_FILENAME" /mnt/driver-daemon/jars
